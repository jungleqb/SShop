...
$pro =$DB->getMoreRows("SELECT * FROM typeproduct WHERE parentId = 0");
$type = $DB->getMoreRows("SELECT * FROM typeproduct WHERE ")



function tree($pro,$parent = 0, $level = 0){
	$result = [];
	foreach($pro as $item){
		if($item->parentId == $parent){
			$item->level = $level;
			$result[] = $item;
			$chil = tree($pro,$item->id,$level +1);
			$result = array_merge($result,$chil);
		}
	}
	return $result;
}
					...
					<ul class="header-btns">
						...
						<li class="header-cart dropdown default-dropdown">
							<a href="gio-hang" id="cart-popover" class="dropdown-toggle" >
								...
								<br>
								<span class="total_price" id="total"> <?=number_format($cart->total());?>đ</span>
							</a>
						</li>
						<!-- /Cart -->
				...
				<div class="category-nav show-on-click">
					...
					<?php foreach($pro as $i): ?>
						<li class="dropdown side-dropdown">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><?=$i->name?><i class="fa fa-angle-right"></i></a>
								...
								<div class="row hidden-sm hidden-xs">
									<div class="col-md-12">
										...
										<a class="banner banner-1" href="#">
											<img src="public/template/img/banner05.jpg" alt="">
								...
								<div class="row">
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="#">
												<img src="public/template/img/banner06.jpg" alt="">
												<div class="banner-caption text-center">
									...
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="#">
												<img src="public/template/img/banner07.jpg" alt="">
												<div class="banner-caption text-center">
									...
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="#">
												<img src="public/template/img/banner08.jpg" alt="">
												<div class="banner-caption text-center">
									...
									<div class="col-md-3">
										<div class="hidden-sm hidden-xs">
											<a class="banner banner-1" href="#">
												<img src="public/template/img/banner09.jpg" alt="">
												<div class="banner-caption text-center">
